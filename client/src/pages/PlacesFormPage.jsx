    ...
    return (
        ...
        <div>
            ...
            <form onSubmit={savePlace} >
                ...
                {preInput('Exter Info', 'House Rules, etc')}
                <textarea
                    value={extraInfo}
                    onChange={ev => setExtraInfo(ev.target.value)} />
                {preInput('Check In&Out Times', 'Add Check in and out times, remeber to have some time window for cleaning the room betwwen guests')}
